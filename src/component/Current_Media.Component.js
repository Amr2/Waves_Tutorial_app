        ...
        <div className="media-cont"> 
            ...
            <div className="contorller-cont">
                <div className="time-controller">
                    ...
                    <input type="range" value={mediainfo.current_time} min="0" max={mediainfo.duration}/>
                    <p>{Format_time(mediainfo.duration)}</p>
                </div>
                <div className="options-controler">
                    <FontAwesomeIcon  size="2x" icon={faAngleDoubleLeft}/>                    
                    <FontAwesomeIcon  onClick={HandlePlayEvent} size="2x" icon={props.isPlaying ? faPause:faPlay}/>                    
                    <FontAwesomeIcon  size="2x" icon={faAngleDoubleRight}/>                    
                </div>
                <audio ref={Media_audio} src={props.CurrMedia.audio} onLoadedMetadata={Mediainfo_handler} onTimeUpdate={Mediainfo_handler} onEnded ={()=> props.SetMediaState(!props.isPlaying)}></audio>
            </div>
        </div>
    )
}